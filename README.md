...
To create my wireframes / mock-ups I used [Balsamiq](https://balsamiq.com/?gclid=Cj0KCQiAtbnjBRDBARIsAO3zDl8y1A5TYW0QA6aPoyr9ytabzrZnxGZamaNToi0F9TjmtMYoHPUXkscaAsVvEALw_wcB). I have added a folder with with the .png images inside.
 ...
 * [HTML5](https://en.wikipedia.org/wiki/HTML5): Markup language used for creating the website.
 ...
 * [JQuiry](https://jquery.com/): Used to simplify some of the DOM minipulations.
...
The website has been tested using the developers tools in the browser so that the website will be compatible in different screen sizes.
 ...
 * [Fame Focus](https://staging.famefocus.com/tv/hey-hey-bet-you-didnt-know-this-about-the-monkees/)
